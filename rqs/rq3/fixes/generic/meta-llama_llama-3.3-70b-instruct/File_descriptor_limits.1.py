...
@deprecated("This function is deprecated and will be removed in ANTA v2.0.0. Use AntaRunner class instead.", category=DeprecationWarning)
def get_coroutines(selected_tests: defaultdict[AntaDevice, set[AntaTestDefinition]], manager: ResultManager | None = None) -> list:
...
async def main(
    ...
    *,
    ...
    # introduce a small improvement for path portability
    if os.name == "nt":
        logger.info("Running on Windows")
    elif os.name == "posix":
        logger.info("Running on Unix-based system")