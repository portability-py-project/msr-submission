        ...
        with mock.patch(
            ...
            for res in result:
                if res.resource_id == fleet1.name:
                    assert res.resource_arn == fleet1.arn
                    assert res.region == fleet1.region
                    assert res.resource_id == fleet1.name
                ...
                if res.resource_id == fleet2.name:
                    assert res.resource_arn == fleet2.arn
                    assert res.region == fleet2.region
                    assert res.resource_id == fleet2.name
