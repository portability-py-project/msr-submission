...
class UniqueFileTest(unittest.TestCase):
    ...
    def test_right_mode(self):
        self.assertEqual(0o700, stat.S_IMODE(os.stat(self._call(0o700)[1]).st_mode))
        self.assertEqual(0o100, stat.S_IMODE(os.stat(self._call(0o100)[1]).st_mode))
...
class UniqueLineageNameTest(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertTrue(isinstance(f, (bytes, str)))
