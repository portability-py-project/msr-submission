...
def show_memory_use():
    ...
    if sys.platform == 'darwin':
        ...
        rusage_denom = 1024.  # Windows uses a different unit for memory, but we keep it in KB for simplicity
    ru = resource.getrusage(resource.RUSAGE_SELF)
    total_memory = (ru.ru_maxrss + ru.ru_ixrss + ru.ru_idrss + ru.ru_isrss) / rusage_denom
