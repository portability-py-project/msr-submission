...
@pytest.mark.skipif(platform.system() == "Windows", reason="Unix-specific system calls")
...
@pytest.mark.skipif(platform.system() == "Windows", reason="Unix-specific functionality")
