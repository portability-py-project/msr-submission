...
class Fleet:
    def __init__(self, arn, name, max_user_duration_in_seconds, disconnect_timeout_in_seconds, idle_disconnect_timeout_in_seconds, enable_default_internet_access, region):
        self.arn = arn
        self.name = name
...
class Test_appstream_fleet_default_internet_access_disabled:
    def test_no_fleets(self):
        ...
        with mock.patch(
            ...
            mock_appstream.return_value = appstream_client
            try:
    ...
    def test_two_fleets_internet_access_one_enabled_one_disabled(self):
        appstream_client = mock.MagicMock()
        appstream_client.fleets = []
        fleet1 = Fleet(
            arn="arn",
