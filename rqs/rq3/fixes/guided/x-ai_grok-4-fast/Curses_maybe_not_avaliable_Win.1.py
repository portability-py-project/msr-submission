...
try:
    from multinosetests.multinosetests import terminal
except ImportError:
    terminal = mock.MagicMock()
    terminal.bold_blue.side_effect = lambda x: x
    terminal.red.side_effect = lambda x: x
    terminal.green.side_effect = lambda x: x
