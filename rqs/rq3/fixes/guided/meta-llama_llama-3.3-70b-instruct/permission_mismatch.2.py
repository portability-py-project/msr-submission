...
def test_secure_delete(tmpdir):
    if os.name == 'nt':  # Windows
        pytest.skip("secure_delete not implemented for Windows")
...
def test_get_system_entropy():
    if os.name == 'nt':  # Windows
        pytest.skip("get_system_entropy not implemented for Windows")
...
def test_is_debugger_present():
    if os.name == 'nt':  # Windows
        pytest.skip("is_debugger_present not implemented for Windows")
...
def test_disable_core_dumps():
    if os.name == 'nt':  # Windows
        pytest.skip("disable_core_dumps not implemented for Windows")
...
def test_harden_process():
    if os.name == 'nt':  # Windows
        pytest.skip("harden_process not implemented for Windows")
...
def test_lock_memory():
    if os.name == 'nt':  # Windows
        pytest.skip("lock_memory not implemented for Windows")
...
def test_secure_delete_directory(tmpdir):
    ...
    with open(file_path, "w") as f:
        f.write("Test data")
    if os.name == 'nt':  # Windows
        pytest.skip("secure_delete_directory not implemented for Windows")
